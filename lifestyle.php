<?php include("include/head.html"); ?> 
   ...
   <?php include("include/top_head.html"); ?> 
    ...
    <div id="container" class="lifestyle clearfix">
    	<header>
	    ...
	    <?php include("include/lifestyle_section_01.html"); ?>
	    <?php include("include/lifestyle_section_02.html"); ?>
	    <?php include("include/lifestyle_section_03.html"); ?>
